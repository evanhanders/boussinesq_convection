...
plotter.setup_grid(num_rows=4, num_cols=1, col_inch=float(args['--col_inch']), row_inch=float(args['--row_inch']))
plotter.add_line('z', 'b', grid_num=0)
plotter.add_line('z', 'Ftot', grid_num=1)
plotter.add_line('z', 'Fconv', grid_num=1)
plotter.add_line('z', 'Fcond', grid_num=1)
plotter.add_line('z', 'KE', grid_num=2)
plotter.add_line('z', 'enstrophy', grid_num=3)
plotter.plot_lines()
