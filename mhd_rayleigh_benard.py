...
problem.parameters['Pm'] = MagneticPrandtl
problem.parameters['Q']  = Chandra
...
problem.substitutions['delta_T'] = '(left(T)-right(T))'
...
analysis_tasks = initialize_magnetic_output(solver, data_dir, aspect, mode=mode, slice_output_dt=0.25)
